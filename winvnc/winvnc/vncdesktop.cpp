...
// Media Player, the SysDaemon Viewer user must desactivate "Hardware accelation"
...
vncDesktop::WriteMessageOnScreenPreConnect(BYTE *scrBuff, UINT scrBuffSize)
{
    ...
    char *tout = "SysDaemon Server Experimental pre-connect window \n";
...
/***************************************************************************
* SysDaemon use 2 different software hooking methods
