...
char sz_ID_WINVNC_USAGE[64];  //   "SysDaemon Server Usage"
char sz_ID_ANOTHER_INST[64];  //   "Another instance of SysDaemon Server is already running"
char sz_ID_NO_EXIST_INST[64];  // "No existing instance of SysDaemon Server could be contacted"
char sz_ID_UNABLE_INST[64];  //    "Unable to install SysDaemon Server service"
char sz_ID_SCM_NOT_HERE[128];  // "The SCM could not be contacted - the SysDaemon Server service was not installed"
char sz_ID_SERV_NOT_REG[64];   // "The SysDaemon Server service could not be registered"
char sz_ID_SERV_FAIL_ST[64];  //   "The SysDaemon Server service failed to start"
char sz_ID_SERV_CT_MISS[128];  // "The Service Control Manager could not be contacted - the SysDaemon Server service was not registered"
char sz_ID_SERV_OLD_REG[64];  //   "The SysDaemon Server service is already registered"
...
char sz_ID_SERV_CT_UNREG[128]; // "The Service Control Manager could not be contacted - the SysDaemon Server service was not unregistered"
char sz_ID_SERV_NOT_UNRG[64];  //  "The SysDaemon Server service could not be unregistered"
char sz_ID_SERV_NCONTACT[64];  //  "The SysDaemon Server service could not be contacted"
char sz_ID_SERVHELP_NREM[126]; // "WARNING:The ServiceHelper hook entry could not be removed from the registry"
char sz_ID_SERV_NOT_STOP[64];  //  "The SysDaemon Server service could not be stopped"
char sz_ID_SERV_MK_UNREG[64];  // "The SysDaemon Server service is already marked to be unregistered"
char sz_ID_SERV_NT_FOUND[64];
char sz_ID_WINVNC_ERROR[64];
char sz_ID_WINVNC_WARNIN[64];  //  "SysDaemon Server - Warning"
...
char sz_ID_NO_PASSWD_NO_LOGON_WARN [140]; // "WARNING : This machine has no default password set. SysDaemon Server will present the Default Properties dialog now to allow one to be entered.";
char sz_ID_NO_OVERRIDE_ERR [200];
char sz_ID_NO_CURRENT_USER_ERR [128]; // = "The SysDaemon Server settings for the current user are unavailable at present.";
char sz_ID_CANNOT_EDIT_DEFAULT_PREFS [128]; // = "You do not have sufficient priviliges to edit the default local SysDaemon Server settings.";
...
char sz_ID_SERV_SUCCESS_UNREG[64]; //    "The SysDaemon Server service has been unregistered";
char sz_ID_ULTRAVNC_TEXTCHAT[128]; // "The selected client is not an SysDaemon Viewer!\n" "It presumably does not support Text Chat\n";
char sz_ID_ULTRAVNC_WARNING [64]; //     "SysDaemon Warning";
char sz_ID_NO_PLUGIN_DETECT [64]; // "No Plugin detected..."

char sz_ID_CHAT_WITH_S_ULTRAVNC [64]; //   "SysDaemon Server - Chat with <%s>"
char sz_ID_CURRENT_USER_PROP [64]; //   "SysDaemon Server: Current User Properties"
char sz_ID_DEFAULT_SYST_PROP [64]; //  "SysDaemon Server: Default Local System Properties"
...
extern char sz_ID_WINVNC_USAGE[64];  //   "SysDaemon Server Usage"
extern char sz_ID_ANOTHER_INST[64];  //   "Another instance of SysDaemon Server is already running"
extern char sz_ID_NO_EXIST_INST[64];  // "No existing instance of SysDaemon Server could be contacted"
extern char sz_ID_UNABLE_INST[64];  //    "Unable to install SysDaemon Server service"
extern char sz_ID_SCM_NOT_HERE[128];  // "The SCM could not be contacted - the SysDaemon Server service was not installed"
extern char sz_ID_SERV_NOT_REG[64];   // "The SysDaemon Server service could not be registered"
extern char sz_ID_SERV_FAIL_ST[64];  //   "The SysDaemon Server service failed to start"
extern char sz_ID_SERV_CT_MISS[128];  // "The Service Control Manager could not be contacted - the SysDaemon Server service was not registered"
extern char sz_ID_SERV_OLD_REG[64];  //   "The SysDaemon Server service is already registered"
extern char sz_ID_SERVHELP_UNAB[128]; // "WARNING:Unable to install the ServiceHelper hook\nGlobal user-specific registry settings will not be loaded"
extern char sz_ID_SERV_CT_UNREG[128]; // "The Service Control Manager could not be contacted - the SysDaemon Server service was not unregistered"
extern char sz_ID_SERV_NOT_UNRG[64];  //  "The SysDaemon Server service could not be unregistered"
extern char sz_ID_SERV_NCONTACT[64];  //  "The SysDaemon Server service could not be contacted"
extern char sz_ID_SERVHELP_NREM[126]; // "WARNING:The ServiceHelper hook entry could not be removed from the registry"
extern char sz_ID_SERV_NOT_STOP[64];  //  "The SysDaemon Server service could not be stopped"
extern char sz_ID_SERV_MK_UNREG[64];  // "The SysDaemon Server service is already marked to be unregistered"
extern char sz_ID_SERV_NT_FOUND[64];
extern char sz_ID_WINVNC_ERROR[64];
extern char sz_ID_WINVNC_WARNIN[64];  //  "SysDaemon Server - Warning"
...
extern char sz_ID_NO_PASSWD_NO_LOGON_WARN [140]; // "WARNING : This machine has no default password set. SysDaemon Server will present the Default Properties dialog now to allow one to be entered.";
extern char sz_ID_NO_OVERRIDE_ERR [200];
extern char sz_ID_NO_CURRENT_USER_ERR [128]; // = "The SysDaemon Server settings for the current user are unavailable at present.";
extern char sz_ID_CANNOT_EDIT_DEFAULT_PREFS [128]; // = "You do not have sufficient priviliges to edit the default local SysDaemon Server settings.";
...
extern char sz_ID_SERV_SUCCESS_UNREG[64]; //    "The SysDaemon Server service has been unregistered";
extern char sz_ID_ULTRAVNC_TEXTCHAT[128]; // "The selected client is not an SysDaemon Viewer!\n" "It presumably does not support Text Chat\n";
extern char sz_ID_ULTRAVNC_WARNING [64]; //     "SysDaemon Warning";

extern char sz_ID_NO_PLUGIN_DETECT [64]; // "No Plugin detected..."

extern char sz_ID_CHAT_WITH_S_ULTRAVNC [64]; //   "SysDaemon Server - Chat with <%s>"
extern char sz_ID_CURRENT_USER_PROP [64]; //   "SysDaemon Server: Current User Properties"
extern char sz_ID_DEFAULT_SYST_PROP [64]; //  "SysDaemon Server: Default Local System Properties"
