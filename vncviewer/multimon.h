...
//
// By using this header your code will work unchanged on Windows 95,
...
//
// if we are building on Windows 95/Windows NT4 headers we need to declare this stuff ourselves
//
#ifndef SM_CMONITORS
